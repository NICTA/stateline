...
namespace stateline
{
  namespace comms
  {
    ...
    //const std::string HDELEGATOR_SOCKET_ADDR = "ipc:///tmp/sl_requester.socket";
    const std::string HDELEGATOR_SOCKET_ADDR = "tcp://*:6666";
